...
- [-] 1. Create data models and session management
  - [~] 1.1 Define EditorSession dataclass with session tracking
  ...
  - [~] 1.2 Define VerticalFormattingJob dataclass for batch processing
  ...
  - [ ] 1.3 Create session storage and retrieval layer
    - Implement in-memory session store with expiry cleanup
    - Add session lookup by session_id
    - _Requirements: 2.1, 11.1_

- [ ] 2. Implement facecam detection backend
  - [ ] 2.1 Create detection endpoint wrapper
...
- [ ] 3. Implement preview generation backend
  ...
  - [ ] 3.3 Implement preview image rendering
...
- [ ] 4. Implement session and confirmation endpoints
  - [ ] 4.1 Create session initialization endpoint
  ...
  - [ ] 4.2 Create confirmation endpoint
  ...
  - [ ] 4.3 Create cancellation endpoint
...
- [ ] 5. Implement undo/redo backend
  ...
  - [ ] 5.3 Write property tests for undo/redo
...
- [ ] 6. Implement vertical formatter core
  - [ ] 6.1 Create VerticalFormatter class
  ...
  - [ ] 6.2 Implement resolution scaling for different source formats
  ...
  - [ ] 6.3 Implement FFmpeg filter generation
  ...
  - [ ] 6.4 Write property tests for vertical formatting
...
- [ ] 7. Implement batch processing and job queue
  - [ ] 7.1 Create batch processing job handler
...
- [ ] 8. Implement output file generation and replacement
  - [ ] 8.1 Create output file naming logic
  ...
  - [ ] 8.2 Implement output file encoding
...
- [ ] 16. Integrate with existing pipeline components
  - [ ] 16.1 Integrate FacecamRelocator
  ...
  - [ ] 16.2 Integrate FrameReformatter
  ...
  - [ ] 16.3 Integrate FFmpeg filter generation
...
- [ ] 17. Implement error handling and fallback options
  - [ ] 17.1 Implement detection failure handling
  ...
  - [ ] 17.2 Implement manual facecam selection mode
  ...
  - [ ] 17.3 Implement fallback fill option
...
- [ ] 18. Implement format-to-vertical prompt
  - [ ] 18.1 Create prompt UI component
...
- [ ] 21. Checkpoint - Ensure all backend and frontend components are integrated
...
- [ ] 22. Write integration tests for API endpoints
  - [ ] 22.1 Test session creation and management
  ...
  - [ ] 22.4 Test confirmation endpoint
...
- [ ] 23. Write integration tests for batch processing
  - [ ] 23.1 Test vertical formatting on single clip
  ...
  - [ ] 23.2 Test batch processing with multiple clips
...
- [ ] 24. Write UI interaction tests
  - [ ] 24.1 Test adjustment control interactions
  ...
  - [ ] 24.2 Test undo/redo button interactions
  ...
  - [ ] 24.3 Test settings panel interactions
...
- [ ] 25. Write accessibility tests
  ...
  - [ ] 25.3 Test color contrast and visual indicators
